...
class AverageDirectionalIndexDTO(BronzeToSilverDTO):
    """
    Silver DTO for FMP /stable/technical-indicators/adx.

    API docs: https://site.financialmodelingprep.com/developer/docs#average-directional-index
    """
    ...
    adx: float | None = field(default=None, metadata={"api": "adx"})

    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "AverageDirectionalIndexDTO":
