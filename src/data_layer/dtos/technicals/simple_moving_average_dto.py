...
class SimpleMovingAverageDTO(BronzeToSilverDTO):
    """
    Silver DTO for FMP /stable/technical-indicators/sma.

    API docs: https://site.financialmodelingprep.com/developer/docs#simple-moving-average
    """
    ...
    sma: float | None = field(default=None, metadata={"api": "sma"})

    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "SimpleMovingAverageDTO":
