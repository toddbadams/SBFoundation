...
class WeightedMovingAverageDTO(BronzeToSilverDTO):
    """
    Silver DTO for FMP /stable/technical-indicators/wma.

    API docs: https://site.financialmodelingprep.com/developer/docs#weighted-moving-average
    """
    ...
    wma: float | None = field(default=None, metadata={"api": "wma"})

    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "WeightedMovingAverageDTO":
