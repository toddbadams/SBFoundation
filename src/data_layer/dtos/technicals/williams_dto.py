...
class WilliamsDTO(BronzeToSilverDTO):
    """
    Silver DTO for FMP /stable/technical-indicators/williams.

    API docs: https://site.financialmodelingprep.com/developer/docs#williams
    """
    ...
    williams: float | None = field(default=None, metadata={"api": "williams"})

    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "WilliamsDTO":
