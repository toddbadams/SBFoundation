...
class CommoditiesPriceEodDTO(BronzeToSilverDTO):
    """
    DTO for FMP commodities historical price EOD data.

    API docs: https://site.financialmodelingprep.com/developer/docs#Commoditiescurrency-historical-price-eod-full
    """
    ...
    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "CommoditiesPriceEodDTO":
    ...
    def key_date(self) -> date:
        d = {"date": self.date}
        return self.d(d, "date") or date.min  # Parse vendor date string
