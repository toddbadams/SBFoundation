...
class FxPriceEodDTO(BronzeToSilverDTO):
    """
    DTO for FMP forex historical price EOD data.

    API docs: https://site.financialmodelingprep.com/developer/docs#forex-historical-price-eod-full
    """
    ...
    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "FxPriceEodDTO":
