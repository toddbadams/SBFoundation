...
class RelativeStrengthIndexDTO(BronzeToSilverDTO):
    """
    Silver DTO for FMP /stable/technical-indicators/rsi.

    API docs: https://site.financialmodelingprep.com/developer/docs#relative-strength-index
    """
    ...
    rsi: float | None = field(default=None, metadata={"api": "rsi"})

    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "RelativeStrengthIndexDTO":
