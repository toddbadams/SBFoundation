...
class StandardDeviationDTO(BronzeToSilverDTO):
    """
    Silver DTO for FMP /stable/technical-indicators/standarddeviation.

    API docs: https://site.financialmodelingprep.com/developer/docs#standard-deviation
    """
    ...
    standard_deviation: float | None = field(default=None, metadata={"api": "standardDeviation"})

    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "StandardDeviationDTO":
