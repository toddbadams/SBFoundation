...
class TripleExponentialMovingAverageDTO(BronzeToSilverDTO):
    """
    Silver DTO for FMP /stable/technical-indicators/tema.

    API docs: https://site.financialmodelingprep.com/developer/docs#triple-exponential-moving-average
    """
    ...
    tema: float | None = field(default=None, metadata={"api": "tema"})

    @classmethod
    def from_row(cls, row: typing.Mapping[str, typing.Any], ticker: str | None = None) -> "TripleExponentialMovingAverageDTO":
